-- TOTAL SAMPLE DATA = 9
-- supplier supplierAddress from Singonegaran, Kediri
...
-- supplier supplierAddress from Pesantren, Kediri
insert into suppliers (id, name, email, gender, mobile_phone, id_address, created_by, created_date, status_record)
...
-- supplier supplierAddress from Keputih, Surabaya
insert into suppliers (id, name, email, gender, mobile_phone, id_address, created_by, created_date, status_record)
...
-- supplier supplierAddress from Tebet Timur, Jakarta Selatan
insert into suppliers (id, name, email, gender, mobile_phone, id_address, created_by, created_date, status_record)
...
-- supplier supplierAddress from Gandaria Utara, Jakarta Selatan
insert into suppliers (id, name, email, gender, mobile_phone, id_address, created_by, created_date, status_record)
